...
if(!isset($_SESSION['Session_AdminStaff_ID'])) {
   	$_SESSION['Session_AdminStaff_ID']=0;
}

if(!isset($_SESSION['Session_Memberlogin_ID'])) {
	$_SESSION['Session_Memberlogin_ID']=0;
}
...
if(!isset($_SESSION['Session_Admin_Language'])) {
   	$_SESSION['Session_Admin_Language']="Thai";//English
}
